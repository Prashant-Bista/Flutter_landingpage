...
class _BlogPostsState extends State<BlogPosts> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(padding: EdgeInsets.only(left:5.0,right: 5.0,top: 50.0),
    child: Container(
      width:200,
      ...
      SizedBox(height:7.0),
        ...
        style: GoogleFonts.openSans(fontSize: 13.0),maxLines: expand==true?null:3,
